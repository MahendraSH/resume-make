...
#let work-item-header(company, location, date, role) = {
  grid(
    columns: (1fr, auto),
    rows: (auto),
    text(weight: "bold", size: 8.0pt, fill: rgb("#0f172a"))[#company] + [ --- ] + text(weight: "medium", style: "italic", fill: rgb("#334155"))[#role],
...
#grid(
  columns: (1fr, auto),
  rows: (auto),
  text(style: "italic", fill: rgb("#475569"))[CGPA: 7.3 / 10 | Relevant Coursework: Data Structures & Algorithms, Database Systems, Software Engineering, DBMS, Object-Oriented Design],
