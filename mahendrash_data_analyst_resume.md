...
**Data Analyst & Software Engineer | SQL, Power BI & Python Ecosystems**

Hyderabad, India | +91-9180165234 | [maahi2001sh@gmail.com](mailto:maahi2001sh@gmail.com) | [GitHub](https://github.com/MahendraSH) | **Immediate Joiner**
...
### Infosys — **Specialist Programmer / Data Analyst & Software Developer** | Jul 2024 – Jun 2026 | Hyderabad, India
...
### Independent Software Development — **Freelance Full-Stack Developer** | Jun 2023 – Jun 2024 | Mysore, India
...
### Merav Infotech — **Software Engineering Intern** | Feb 2024 – May 2024 | Mysore, India
...
### Cargo Readiness — CMA CGM — *SQL, PostgreSQL, Power BI, Java 21, Spring Boot, Kafka*
...
### SpendOptima — Personal Finance Analytics Dashboard — *React, TypeScript, Next.js, Recharts*
...
### SaaS Form Builder & Analytics Platform — *PostgreSQL, Express, React, Node.js, AWS*
...
### E-Commerce REST API Platform — *Python, Django, Flask, FastAPI, PostgreSQL, Node.js, Express.js*
...
- **Data Analyst Associate** — DataCamp *(Credential ID: DAA0011831242181 | Issued Sep 2026)*
- **PostgreSQL & Advanced SQL Specialization** — DataCamp *(Joining Data & Manipulating Data in PostgreSQL | Issued Sep 2026)*

---

## Education

### National Institute of Engineering (NIE) — **Bachelor of Technology (B.Tech) in Computer Science & Engineering** | Graduated May 2024

*CGPA: 7.3 / 10 | Relevant Coursework: Data Structures & Algorithms, Database Systems, DBMS, Software Engineering, Object-Oriented Design — Mysore, India*
