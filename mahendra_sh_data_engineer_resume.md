...
- **Data Engineering & Cloud:** Advanced SQL, AWS (S3, SQS, SNS, Cost Explorer), ETL/ELT Pipelines, Data Modeling, Docker, CI/CD
...
### **Independent Software Development** — *Freelance Backend & Data Engineer*  
...
### **ProjectX Generative AI Studio (LLMOps Pipeline)** • *Python, Next.js, Langfuse, AWS S3, SQL*
...
### **Cargo Readiness — CMA CGM Project** • *Java 21, Spring Batch, AWS SQS/SNS, PostgreSQL, Power BI*
...
### **SaaS Form Builder Data Platform** • *Node.js, PostgreSQL, AWS, TypeScript*
...
### **SpendOptima Analytics Dashboard** • *TypeScript, PostgreSQL, SQL Analytics*
...
### **National Institute of Engineering (NIE)** — *Bachelor of Technology (B.Tech) in Computer Science & Engineering*  
*Graduated May 2024* | *Mysore, India*  
CGPA: 7.3 / 10 | *Relevant Coursework:* Database Systems, Software Engineering, DBMS, Object-Oriented Design
